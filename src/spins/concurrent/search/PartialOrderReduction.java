...
package spins.concurrent.search;

import spins.concurrent.model.ConcurrentModel;
import spins.concurrent.model.ConcurrentTransition;
import spins.concurrent.model.Process;
import spins.model.MetaInfo;
import spins.search.SearchableStack;
...
public class PartialOrderReduction<M extends ConcurrentModel<T>, T extends ConcurrentTransition<T>>
	...
	/**
	 * @see spins.search.TransitionCalculator#next(spins.model.Model, spins.model.Transition)
	 */
	@Override
	 ...
	 * @see TransitionCalculator#duplicateState(spins.model.Model, spins.model.Transition, byte[],
	 *      int, SearchableStack)
	 */
	@Override
