...
import spins.promela.exceptions.TooManyChannelsException;
import spins.promela.exceptions.TooManyProcessesException;
...
public abstract class PromelaModel extends ConcurrentModel<PromelaTransition> {
	...
	/**
	 * @see spins.concurrent.model.ConcurrentModel#getName()
	 */
	@Override
	...
	/**
	 * @see spins.concurrent.model.ConcurrentModel#conditionHolds(int)
	 */
	@Override
