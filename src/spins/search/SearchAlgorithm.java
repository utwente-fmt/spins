...
import static spins.search.Message.DEADLOCK;
import static spins.search.Message.DUPLICATE_STATE;
import static spins.search.Message.EXCEED_DEPTH_ERROR;
import static spins.search.Message.EXCEED_DEPTH_WARNING;
import static spins.search.Message.NO_MORE_TRANSITIONS;
import static spins.search.Message.TRANS_ERROR;
...
import spins.exceptions.SpinJaException;
import spins.model.Condition;
import spins.model.Model;
import spins.model.Transition;
import spins.store.StateStore;
import spins.store.hash.HashAlgorithm;
import spins.util.ByteArrayStorage;
...
public abstract class SearchAlgorithm<M extends Model<T>, 
	...
	/**
	 * @see spins.search.Algoritm#getNrStates()
	 */
	@Override
