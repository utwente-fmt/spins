...
import spins.model.listener.PrintEvent;
import spins.model.listener.PrintListener;
...
public abstract class Simulation<M extends Model<T>, 
	...
	/**
	 * Constructor of Simulation using an {@link spins.model.Model}.
	 * 
	 * @param model
	 *            The {@link spins.model.Model} that we are going to simulate.
	 */
	 ...
	 * 
	 * @see spins.search.Algoritm#execute()
	 */
	@Override
	...
	/**
	 * @see spins.search.Algoritm#freeMemory()
	 */
	@Override
	...
	/**
	 * @see spins.search.Algoritm#getBytes()
	 */
	@Override
	...
	/**
	 * @see spins.search.Algoritm#printSummary()
	 */
	@Override
