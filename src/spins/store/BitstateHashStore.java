...
import spins.store.hash.JenkinsHash;
import spins.store.hash.HashAlgorithm.HashGenerator;
import spins.store.hash.HashAlgorithm.LongHashGenerator;
...
public class BitstateHashStore extends StateStore {
	...
	/**
	 * @see spins.store.StateStore#addState(byte[])
	 */
	@Override
	...
	/**
	 * @see spins.store.StateStore#getBytes()
	 */
	@Override
	...
	/**
	 * @see spins.store.StateStore#getStored()
	 */
	@Override
	...
	/**
	 * @see spins.store.StateStore#printSummary()
	 */
	@Override
