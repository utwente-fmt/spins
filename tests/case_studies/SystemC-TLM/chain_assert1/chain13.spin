...
active proctype source(){
   ...
   do
   :: atomic{myturn && state==1 -> f1=1;state=2;M=15}
...
active proctype p1(){
   ...
   :: atomic{myturn && state==3 -> f2=1;state=4;M=20}
...
active proctype p10(){
   ...
   :: atomic{myturn && state==3 -> f11=1;state=4;M=17}
...
active proctype p11(){
   ...
   :: atomic{myturn && state==3 -> f12=1;state=4;M=18}
...
active proctype p12(){
   ...
   :: atomic{myturn && state==3 -> f13=1;state=4;M=19}
...
active proctype p13(){
   ...
   :: atomic{myturn && state==3 -> fsink=1;state=4;M=28}
...
active proctype p2(){
   ...
   :: atomic{myturn && state==3 -> f3=1;state=4;M=21}
...
active proctype p3(){
   ...
   :: atomic{myturn && state==3 -> f4=1;state=4;M=22}
...
active proctype p4(){
   ...
   :: atomic{myturn && state==3 -> f5=1;state=4;M=23}
...
active proctype p5(){
   ...
   :: atomic{myturn && state==3 -> f6=1;state=4;M=24}
...
active proctype p6(){
   ...
   :: atomic{myturn && state==3 -> f7=1;state=4;M=25}
...
active proctype p7(){
   ...
   :: atomic{myturn && state==3 -> f8=1;state=4;M=26}
...
active proctype p8(){
   ...
   :: atomic{myturn && state==3 -> f9=1;state=4;M=27}
...
active proctype p9(){
   ...
   :: atomic{myturn && state==3 -> f10=1;state=4;M=16}
...
active proctype fun_10(){
   ...
   :: atomic{myturn && state==2 -> e10=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f10=0;state=4;M=14}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_3(){
   ...
   :: atomic{myturn && state==2 -> e3=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f3=0;state=4;M=7}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_4(){
   ...
   :: atomic{myturn && state==2 -> e4=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f4=0;state=4;M=8}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_5(){
   ...
   :: atomic{myturn && state==2 -> e5=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f5=0;state=4;M=9}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_6(){
   ...
   :: atomic{myturn && state==2 -> e6=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f6=0;state=4;M=10}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_7(){
   ...
   :: atomic{myturn && state==2 -> e7=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f7=0;state=4;M=11}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_8(){
   ...
   :: atomic{myturn && state==2 -> e8=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f8=0;state=4;M=12}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_9(){
   ...
   :: atomic{myturn && state==2 -> e9=0;state=3;M=this}
   :: atomic{myturn && state==3 -> f9=0;state=4;M=13}
   :: atomic{myturn && state==4 -> break}
   od
}
...
active proctype fun_sink(){
   ...
   :: atomic{myturn && state==3 -> fsink=0;state=4;M=6}
   :: atomic{myturn && state==4 -> break}
   od
}
