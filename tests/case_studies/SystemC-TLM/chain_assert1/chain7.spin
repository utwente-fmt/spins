...
active proctype source(){
   ...
   do
   :: atomic{myturn && state==1 -> f1=1;state=2;M=9}
...
active proctype p1(){
   ...
   :: atomic{myturn && state==3 -> f2=1;state=4;M=10}
...
active proctype p2(){
   ...
   :: atomic{myturn && state==3 -> f3=1;state=4;M=11}
...
active proctype p3(){
   ...
   :: atomic{myturn && state==3 -> f4=1;state=4;M=12}
...
active proctype p4(){
   ...
   :: atomic{myturn && state==3 -> f5=1;state=4;M=13}
...
active proctype p5(){
   ...
   :: atomic{myturn && state==3 -> f6=1;state=4;M=14}
...
active proctype p6(){
   ...
   :: atomic{myturn && state==3 -> f7=1;state=4;M=15}
...
active proctype p7(){
   ...
   :: atomic{myturn && state==3 -> fsink=1;state=4;M=16}
